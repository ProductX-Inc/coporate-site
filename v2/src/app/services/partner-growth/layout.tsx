...
const faqJsonLd = buildFaqJsonLd([
    { q: "最低契約期間はありますか？", a: "案件の規模や内容に応じて柔軟に対応しております。最短1ヶ月のスポット支援から、中長期のパートナーシップまで幅広く承ります。" },
    { q: "開発だけでなく、企画・戦略から相談できますか？", a: "もちろんです。ProductXの強みは上流のプロダクト戦略から実装・グロースまで一気通貫で支援できることです。「何を作るべきか」の段階からご相談いただけます。" },
    { q: "リモートでの対応は可能ですか？", a: "はい、フルリモートでの対応が可能です。オンラインミーティングやチャットツールを活用し、スムーズなコミュニケーションを実現します。" },
    { q: "NDAの締結は可能ですか？", a: "はい、プロジェクト開始前にNDA（秘密保持契約）の締結が可能です。情報管理には万全の体制を整えております。" },
    { q: "料金体系を教えてください。", a: "プロジェクトの規模・内容に応じたお見積もりを作成いたします。準委任契約（月額）と請負契約（固定）の両方に対応しております。" },
]);
