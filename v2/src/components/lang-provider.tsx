...
const translations: Record<string, Record<Locale, string>> = {
    ...
    "contact.error.network": { ja: "送信に失敗しました。時間をおいて再度お試しください。", en: "Failed to send. Please try again later." },
    "contact.error.emailMismatch": { ja: "メールアドレスが一致しません。", en: "Email addresses do not match." },
