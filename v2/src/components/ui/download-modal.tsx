...
import { X, Download, Lock, AlertTriangle } from "lucide-react";
import Link from "next/link";
import { useLang } from "@/components/lang-provider";

type ModalState = "idle" | "error" | "locked";
...
export function DownloadModal({ isOpen, onClose }: DownloadModalProps) {
    ...
    const isDisabled = !password || state === "locked";
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <button
                                type="submit"
                                disabled={isDisabled}
                                className={`w-full mt-4 py-3 rounded-xl text-sm font-semibold transition-all duration-300 flex items-center justify-center gap-2 ${isDisabled
